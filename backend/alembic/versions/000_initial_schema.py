...
def upgrade() -> None:
    ...
    filetype_enum = postgresql.ENUM("pdf", "audio", "video", name="filetype", create_type=False)
    processingstatus_enum = postgresql.ENUM(
        "uploaded", "processing", "completed", "failed", name="processingstatus", create_type=False
    )
